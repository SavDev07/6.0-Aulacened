...
def main():
    ...
    bot_token = '5232348356:AAHPacAlATf6VDeaCTh-5_SDWKbpxwEbjg4'
    ...
    async def dispatch_event(ev: events.NewMessage.Event):
            ...
            if user_info or user_name == tl_admin_user:  # validate user
                ...
                await bot.send_message(ev.chat_id, infos.noAcces(user_name))
            pass
